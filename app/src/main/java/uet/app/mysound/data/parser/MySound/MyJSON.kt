...
//"""
//
//    val resultList = parseMixedContentMySound(jsonData)
//
//    // In ra tất cả các phần tử trong danh sách
//    resultList.forEachIndexed { index, homeItem ->
//        println("HomeItem $index:")
//        println("Title: ${homeItem.title}")
//        println("Subtitle: ${homeItem.subtitle}")
//        println("ChannelId: ${homeItem.channelId}")
//
//        homeItem.contents?.forEachIndexed { contentIndex, content ->
//            println("  Content $contentIndex:")
//            println("    Title: ${content?.title}")
//            println("    Album: ${content?.album?.name}")
//            println("    Artists:")
//            content?.artists?.forEach { artist ->
//                println("      ${artist.name}")
//            }
//            // In thêm các thông tin khác tùy theo nhu cầu
//
//            println("    Thumbnails:")
//            content?.thumbnails?.forEachIndexed { thumbnailIndex, thumbnail ->
//                println("      Thumbnail $thumbnailIndex:")
//                println("        URL: ${thumbnail.url}")
//                println("        Height: ${thumbnail.height}")
//                println("        Width: ${thumbnail.width}")
//            }
//        }
//        println()
//    }
