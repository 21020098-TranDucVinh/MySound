...
import uet.app.mysound.data.model.explore.mood.genre.ItemsSong
import uet.app.mysound.data.model.explore.mood.genre.Title
        ...
        if (items != null) {
            for (item in items) {
                if (item.musicCarouselShelfRenderer != null) {
                    ...
                    val listContent: MutableList<uet.app.mysound.data.model.explore.mood.genre.Content> = mutableListOf()
                    if (!contents.isNullOrEmpty()) {
                        for (content in contents) {
                            if (content.musicResponsiveListItemRenderer != null) {
                                //Song
                                ...
                                val playlistBrowseId =
                                    content.musicTwoRowItemRenderer?.navigationEndpoint?.browseEndpoint?.browseId
                                listContent.add(
                                    uet.app.mysound.data.model.explore.mood.genre.Content(
                                        playlistBrowseId = playlistBrowseId ?: "",
