...
import uet.app.youtubeExtractor.models.SectionListRenderer
...
fun Thumbnail.toThumbnail(): uet.app.mysound.data.model.searchResult.songs.Thumbnail {
    return uet.app.mysound.data.model.searchResult.songs.Thumbnail(
...
fun List<Thumbnail>.toListThumbnail(): List<uet.app.mysound.data.model.searchResult.songs.Thumbnail> {
    val list = mutableListOf<uet.app.mysound.data.model.searchResult.songs.Thumbnail>()
    this.forEach {
