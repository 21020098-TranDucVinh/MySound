...
interface SearchService {
    ...
    suspend fun searchSongs(
        ...
        @Query("f") filter: String = "songs"
    ): Response<ArrayList<SongsResult>>

    @GET("search")
    suspend fun searchArtists(
        @Query("q") query: String,
        @Query("f") filter: String = "artists"
    ): Response<ArrayList<ArtistsResult>>

    @GET("search")
    suspend fun searchAlbums(
        @Query("q") query: String,
        @Query("f") filter: String = "albums"
    ): Response<ArrayList<AlbumsResult>>

    @GET("search")
    suspend fun searchPlaylists(
        @Query("q") query: String,
        @Query("f") filter: String = "playlists"
    ): Response<ArrayList<PlaylistsResult>>
