...
import uet.app.youtubeExtractor.models.AccountInfo
...
import uet.app.youtubeExtractor.models.GridRenderer
import uet.app.youtubeExtractor.models.MediaType
import uet.app.youtubeExtractor.models.MusicCarouselShelfRenderer
import uet.app.youtubeExtractor.models.PlaylistItem
import uet.app.youtubeExtractor.models.Run
...
import uet.app.youtubeExtractor.models.YouTubeClient.Companion.ANDROID_MUSIC
import uet.app.youtubeExtractor.models.YouTubeClient.Companion.TVHTML5
import uet.app.youtubeExtractor.models.YouTubeClient.Companion.WEB_REMIX
import uet.app.youtubeExtractor.models.YouTubeLocale
import uet.app.youtubeExtractor.models.getContinuation
import uet.app.youtubeExtractor.models.musixmatch.MusixmatchCredential
import uet.app.youtubeExtractor.models.musixmatch.MusixmatchLyricsReponse
import uet.app.youtubeExtractor.models.musixmatch.MusixmatchLyricsResponseByQ
...
import uet.app.youtubeExtractor.models.musixmatch.UserTokenResponse
import uet.app.youtubeExtractor.models.oddElements
import uet.app.youtubeExtractor.models.response.AccountMenuResponse
import uet.app.youtubeExtractor.models.response.AddItemYouTubePlaylistResponse
import uet.app.youtubeExtractor.models.response.BrowseResponse
import uet.app.youtubeExtractor.models.response.CreatePlaylistResponse
import uet.app.youtubeExtractor.models.response.GetQueueResponse
import uet.app.youtubeExtractor.models.response.GetSearchSuggestionsResponse
import uet.app.youtubeExtractor.models.response.NextResponse
...
import uet.app.youtubeExtractor.models.youtube.data.YouTubeDataPage
...
import uet.app.youtubeExtractor.pages.ExplorePage
import uet.app.youtubeExtractor.pages.MoodAndGenres
import uet.app.youtubeExtractor.pages.NewReleaseAlbumPage
import uet.app.youtubeExtractor.pages.NextPage
import uet.app.youtubeExtractor.pages.NextResult
import uet.app.youtubeExtractor.pages.PlaylistContinuationPage
import uet.app.youtubeExtractor.pages.PlaylistPage
import uet.app.youtubeExtractor.pages.RelatedPage
import uet.app.youtubeExtractor.pages.SearchPage
import uet.app.youtubeExtractor.pages.SearchResult
import uet.app.youtubeExtractor.pages.SearchSuggestionPage
import uet.app.youtubeExtractor.parser.parseMusixmatchLyrics
import uet.app.youtubeExtractor.parser.parseUnsyncedLyrics
...
object YouTube {
    ...
    suspend fun artist(browseId: String): Result<ArtistPage> = runCatching {
        ...
        ArtistPage(
            ...
            subscribers = response.header?.musicImmersiveHeaderRenderer?.subscriptionButton?.subscribeButtonRenderer?.longSubscriberCountText?.runs?.get(
                0
            )?.text,
    ...
    suspend fun postMusixmatchCredentials(email: String, password: String, userToken: String) =
        runCatching {
    ...
    suspend fun getMusixmatchLyrics(trackId: String, userToken: String) = runCatching {
        val response =
            ytMusic.getMusixmatchLyrics(trackId, userToken).body<MusixmatchLyricsReponse>()
        if (response.message.body.subtitle != null) {
            ...
            val unsyncedResponse = ytMusic.getMusixmatchUnsyncedLyrics(trackId, userToken)
    ...
    suspend fun explore(): Result<ExplorePage> = runCatching {
        val response =
            ytMusic.browse(WEB_REMIX, browseId = "FEmusic_explore").body<BrowseResponse>()
        ExplorePage(
    ...
    suspend fun browse(browseId: String, params: String?): Result<BrowseResult> = runCatching {
        val response =
            ytMusic.browse(WEB_REMIX, browseId = browseId, params = params).body<BrowseResponse>()
        BrowseResult(
...
//                    authorSubCount = piped.uploaderSubscriberCount,
    ...
    suspend fun lyrics(endpoint: BrowseEndpoint): Result<String?> = runCatching {
        val response =
            ytMusic.browse(WEB_REMIX, endpoint.browseId, endpoint.params).body<BrowseResponse>()
    ...
    suspend fun getYTMusicSearchSuggestions(query: String) = runCatching {
        val response =
            ytMusic.getSearchSuggestions(WEB_REMIX, query).body<GetSearchSuggestionsResponse>()
        SearchSuggestions(
